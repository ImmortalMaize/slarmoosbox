...
export class SpectrumEditorPrompt extends Importable implements Prompt {
    static promptName: string[] = ["spectrumSettings", "drumsetSettings"];
    static args: ImportableArgs[][] = [["editor", false], ["editor", true]];
    //@ts-ignore
